...
const Navbar = ({ onToggleSidebar, sidebarOpen }) => {
  ...
  return (
    <nav className="glass fixed top-0 left-0 right-0 z-50 h-16 flex items-center justify-between px-4 lg:px-6 transition-all duration-300">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="relative" ref={notifRef}>
          ...
          {showNotif && (
            <div className="absolute right-0 top-full mt-2 w-80 sm:w-96 glass-neu-card rounded-2xl shadow-2xl z-50 border border-white/15 overflow-hidden animate-fade-in-up">
              <div className="flex items-center justify-between p-3.5 border-b border-white/10 bg-slate-900/50">
        ...
        <div className="relative" ref={profileRef}>
          ...
          {/* Profile Dropdown */}
          {showProfile && (
            <div className="absolute right-0 top-full mt-2 w-64 glass-neu-card rounded-2xl p-2 shadow-2xl z-50 border border-white/15 animate-fade-in-up">
              {/* User Header */}
              ...
              <div className="space-y-0.5">
                <Link
                  ...
                  className="flex items-center gap-2.5 px-3 py-2 rounded-xl hover:bg-white/10 transition-colors text-xs font-medium text-text-secondary hover:text-text-primary"
                >
                  <User size={15} className="text-indigo-400" /> My Profile & Badges
                </Link>
                ...
                {['admin', 'club_admin', 'faculty'].includes(user?.role) && (
                  <Link
                    ...
                    className="flex items-center gap-2.5 px-3 py-2 rounded-xl hover:bg-white/10 transition-colors text-xs font-medium text-text-secondary hover:text-text-primary"
                  >
                    <BarChart3 size={15} className="text-cyan-400" /> Campus Analytics
                  </Link>
                )}
                ...
                {user?.role === 'admin' && (
                  <Link
                    ...
                    className="flex items-center gap-2.5 px-3 py-2 rounded-xl hover:bg-white/10 transition-colors text-xs font-medium text-text-secondary hover:text-text-primary"
                  >
                    <Shield size={15} className="text-rose-400" /> Admin Control Hub
                  </Link>
                )}
              </div>
              ...
              <button
                ...
                className="flex items-center gap-2.5 px-3 py-2 rounded-xl hover:bg-rose-500/15 transition-colors text-xs font-semibold text-rose-400 hover:text-rose-300 w-full text-left cursor-pointer"
              >
