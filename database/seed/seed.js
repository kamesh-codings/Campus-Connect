  ...
  try {
    ...
    const users = await User.create([
      ...
      },
      {
        ...
        yearOfStudy: 3,
        studentId: 'CS21098',
        bio: 'Tamil computing enthusiast, open-source contributor, and web developer.',
        skills: ['React', 'Node.js', 'Python', 'TailwindCSS'],
        interests: ['Hackathons', 'Tamil NLP', 'Web Dev'],
      },
      {
        ...
        yearOfStudy: 3,
        studentId: 'IT21042',
        bio: 'Club Lead & Full-Stack Developer | Community Organizer',
        skills: ['Public Speaking', 'React.js', 'Node.js', 'MongoDB', 'Event Management'],
        interests: ['Open Source Software', 'SaaS Development'],
      },
      {
        ...
        role: 'faculty',
        department: 'CSE',
        bio: 'Professor & Head of CSE. Research: Machine Learning & NLP.',
        skills: ['Data Structures', 'Python', 'Deep Learning', 'Compiler Design'],
        interests: ['Indic Language AI', 'Student Mentorship'],
      },
    ]);
